    ...
    public class FileSystemManager {
        ...
        private void buildTreeNode(DefaultMutableTreeNode parentNode, Directory directory) {
            ...
            // Añadir sub-directorios recursivo
        ...
        public boolean createFile(String dirPath, String fileName, int fileSize) {
            ...
            if (getStorage().getAvailableStorage() < fileSize) {
                return false;
            }

            // Asigna los bloques usando el Storage refactorizado
            getStorage().allocateBlocks(newFile);
        ...
        public boolean deleteFile(String path) {
            ...
            // Liberar bloques
            getStorage().deleteFile(fileToDelete);
        ...
        public boolean deleteDirectory(String path) {
            ...
            // Buscar el directorio especifico
            SimpleList<Directory> subdirs = parent.getSubdirectories();
            ...
            // Elimina recursivo (Para eliminar las sub-carpetas y archivos que contenga)
        ...
        // Retorna informacion del archivo
        ...
        private Directory findDirectoryByPath(String path) {
            ...
            for (int i = 2; i < components.length; i++) {
                ...
                if (!found) {
                    return null; // No se encontro el dirEctorio
                }
            }
